...
public class MusicShopDisplay extends GCanvas
	...
	/*
	 * Display the album name, band number in stock
	 * for a single album if it is in our inventory. 
	...
	public void displayInventory(Album album) {
		...
		if (album != null) {
			...
			// Display squares in dictating how many inventory
			double nextX = SPACER;
	...
	/*
	 * Whenever we need to u[date the display, continue
	 * to display the last album shown
	 */
	public void update() {
