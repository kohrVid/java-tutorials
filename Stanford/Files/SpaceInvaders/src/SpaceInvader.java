/*
 * File: SpaceInvader.java
 * -----------------------
 * This program plays a game where the user
 * tries to shoot a UFO before the UFO lands
 */
import acm.graphics.*;
import acm.program.*;
...
public class SpaceInvader extends GraphicsProgram {
	 ...
	 * the UFO is destroy or if the UFO lands
	 */
	...
	/**
	 * when mouse is clicked create bullet, unless
	 * a bullet already exists
	 */
	...
	/** 
	 * checks for bullet interaction with the 
	 * world (either colliding with the UFO or moving
	 * off screen)
	 */
	...
	private boolean ufoToLeft; /// when true, UFO moves to the left
}