...
import com.demo.rest.models.User;
import com.demo.rest.models.Users;
...
public class UserService {
  ...
  @GET
  @Path("/users")
  @Produces("application/vnd.com.demo.users+xml;charset=UTF-8;version=1")
  ...
  @GET
  @Path("/users/{id}")
  @Produces("application/vnd.com.demo.user-management.user_xml;charset=UTF-8;version=1")
